...
type GetReq struct {
	g.Meta   `path:"/play" method:"get" tags:"LivePlay" summary:"Get public play info" dc:"Resolve one publicly visible live for anonymous viewers by live-room code and explicit tenant ID. The endpoint prefers an ongoing public live, falls back to the latest finished public live as a replay, and finally to the latest not-started public live as a preview. Private lives never resolve, and the play URL stays empty for not-started lives. The push URL and other administrative fields are never exposed."`
